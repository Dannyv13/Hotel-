...
--
/*!50003 DROP PROCEDURE IF EXISTS `getCustomerTotal` */;
...
DELIMITER ;;
CREATE DEFINER=`root`@`localhost` PROCEDURE `getCustomerTotal`(IN customerLastName VARCHAR(100), 
...
-- Dump completed on 2021-12-05 15:43:41
